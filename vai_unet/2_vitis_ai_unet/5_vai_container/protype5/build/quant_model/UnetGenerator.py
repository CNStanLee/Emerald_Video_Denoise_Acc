...
class UnetGenerator(torch.nn.Module):
    def __init__(self):
        ...
        self.module_2 = py_nndct.nn.LeakyReLU(negative_slope=0.1, inplace=True) #UnetGenerator::UnetGenerator/UnetSkipConnectionBlock[model]/Sequential[model]/UnetSkipConnectionBlock[1]/Sequential[model]/LeakyReLU[0]/input.5
        ...
        self.module_4 = py_nndct.nn.LeakyReLU(negative_slope=0.1, inplace=True) #UnetGenerator::UnetGenerator/UnetSkipConnectionBlock[model]/Sequential[model]/UnetSkipConnectionBlock[1]/Sequential[model]/UnetSkipConnectionBlock[3]/Sequential[model]/LeakyReLU[0]/input.9
        ...
        self.module_6 = py_nndct.nn.LeakyReLU(negative_slope=0.1, inplace=True) #UnetGenerator::UnetGenerator/UnetSkipConnectionBlock[model]/Sequential[model]/UnetSkipConnectionBlock[1]/Sequential[model]/UnetSkipConnectionBlock[3]/Sequential[model]/UnetSkipConnectionBlock[3]/Sequential[model]/LeakyReLU[0]/input.13
